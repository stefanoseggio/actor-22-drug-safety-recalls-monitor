...
export declare function classifyFdaRecord(previous: RecordFingerprint | undefined, current: RecordFingerprint): FdaEventType;
export declare function classifyEmaRecord(previous: RecordFingerprint | undefined, current: RecordFingerprint): EmaEventType;
