...
export function parseFdaDateToIso(value) {
    if (!value)
        return null;
...
export function parseEuDateToIso(value) {
    if (!value)
        return null;
 ...
 * trigger it silently.
 */
export function isWithinDateRange(isoDate, preset, now) {
    if (!preset)
        return true;
    if (!isoDate)
        return false;
