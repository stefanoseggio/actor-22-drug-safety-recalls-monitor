...
import { EmaAlertRecordSchema, FdaRecallRecordSchema, REGULATORY_DATA_DISCLAIMER, } from './schemas.js';
...
export function normalizeFdaRecord(raw, options) {
...
function slugFromDhpcUrl(url) {
    const parts = url.split('/').filter(Boolean);
    return parts[parts.length - 1] || url;
}
export function normalizeEmaRecord(raw, options) {
