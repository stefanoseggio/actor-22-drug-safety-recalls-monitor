 ...
 */
export function fdaFingerprintOf(raw: {
    status: string;
    ...
    return {
        statusFingerprint: hashOf({ status: raw.status }),
        contentFingerprint: hashOf({
            ...
            code_info: raw.code_info ?? null,
            more_code_info: raw.more_code_info ?? null,
        }),
    };
}
 ...
 */
export function emaFingerprintOf(raw: {
    ...
    return {
        statusFingerprint: hashOf({ regulatory_outcome: raw.regulatory_outcome }),
        contentFingerprint: hashOf({
            name_of_medicine: raw.name_of_medicine,
            active_substances: raw.active_substances,
            dhpc_type: raw.dhpc_type,
            atc_code_human: raw.atc_code_human,
            therapeutic_area_mesh: raw.therapeutic_area_mesh,
            procedure_number: raw.procedure_number,
            referral_name: raw.referral_name,
